...
export declare const TRACKER_EXT_ID = "mcu-debug.debug-tracker-vscode";
...
export declare class DebugTracker implements IDebugTracker {
    private context;
    private tracker;
    constructor(context: vscode.ExtensionContext, dbgChannel?: vscode.OutputChannel | vscode.LogOutputChannel, dbgLevel?: 0 | 1 | 2);
    subscribe(arg: IDebuggerTrackerSubscribeArg): IDebuggerSubscription | string;
    unsubscribe(clientId: string): void;
    getSessionStatus(sessionId: string): DebugSessionStatus;
    getSessionInfo(sessionId: string): ITrackedDebugSession | undefined;
    setDbgChannel(dbgChannel: vscode.OutputChannel | vscode.LogOutputChannel, dbgLevel: 0 | 1 | 2): void;
    static getTrackerExtension(callerExtName: string, maxTimeout?: number): Promise<IDebugTracker | Error>;
}
